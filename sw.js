...
var SHELL_CACHE = 'llm-map-shell-v13';
var PAGE_CACHE = 'llm-map-pages-v1';
var SHELL = ["./", "./index.html", "./css/styles.css?v=4.4.2", "./css/game.css?v=4.4.2", "./data/syllabus.js?v=4.4.2", "./data/index.js?v=4.4.2", "./js/md.js?v=4.4.2", "./js/judge.js?v=4.4.2", "./js/app.js?v=4.4.2"];
