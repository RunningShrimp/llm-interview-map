...
var SHELL_CACHE = 'llm-map-shell-v9';
var PAGE_CACHE = 'llm-map-pages-v1';
var SHELL = ["./", "./index.html", "./css/styles.css?v=4.3.1", "./css/game.css?v=4.3.1", "./data/syllabus.js?v=4.3.1", "./data/index.js?v=4.3.1", "./js/judge.js?v=4.3.1", "./js/app.js?v=4.3.1"];
