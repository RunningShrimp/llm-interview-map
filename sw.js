...
var SHELL_CACHE = 'llm-map-shell-v14';
var PAGE_CACHE = 'llm-map-pages-v1';
var SHELL = ["./", "./index.html", "./css/styles.css?v=4.5.0", "./css/game.css?v=4.5.0", "./data/syllabus.js?v=4.5.0", "./data/index.js?v=4.5.0", "./js/md.js?v=4.5.0", "./js/judge.js?v=4.5.0", "./js/app.js?v=4.5.0"];
