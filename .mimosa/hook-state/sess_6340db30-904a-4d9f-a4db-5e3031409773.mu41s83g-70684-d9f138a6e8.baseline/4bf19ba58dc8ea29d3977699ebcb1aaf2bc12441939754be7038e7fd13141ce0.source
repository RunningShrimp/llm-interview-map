...
var SHELL_CACHE = 'llm-map-shell-v1';
var PAGE_CACHE = 'llm-map-pages-v1';
var SHELL = ["./", "./index.html", "./css/styles.css?v=2.0.1", "./css/game.css?v=2.0.1", "./data/syllabus.js?v=2.0.1", "./js/judge.js?v=2.0.1", "./js/app.js?v=2.0.1"];
